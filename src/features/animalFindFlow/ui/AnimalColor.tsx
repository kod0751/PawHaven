    ...
    <Container>
      ...
      <div className="flex justify-center items-center my-10 gap-4">
        <button
          ...
          className="w-40 h-11 lg:w-60 lg:h-14 mt-2 rounded-full bg-orange-500 flex items-center justify-center font-[NanumSquareNeoExtraBold] text-md lg:text-xl text-white cursor-pointer"
        >
          이전
          <img
        ...
        <button
          ...
          className={`w-40 h-11 lg:w-60 lg:h-14 mt-2 rounded-full border-0 flex items-center justify-center font-[NanumSquareNeoExtraBold] text-md lg:text-xl text-white transition ${
            isMinimumSelected
